...
public class UserAdminController {
	...
	public String list(Model model) {
		List<SsUser> users = accountService.getAllUser();
	...
	public String update(@Valid @ModelAttribute("preloadUser") SsUser user, RedirectAttributes redirectAttributes) {
	...
	public String delete(@PathVariable("id") Long id, RedirectAttributes redirectAttributes) {
		SsUser user = accountService.getUser(id);
